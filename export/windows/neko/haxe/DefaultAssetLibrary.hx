...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/alien.png", "assets/images/alien.png");
		...
		path.set ("assets/images/tirobueno.png", "assets/images/tirobueno.png");
		type.set ("assets/images/tirobueno.png", AssetType.IMAGE);
		path.set ("assets/images/tiromalo.png", "assets/images/tiromalo.png");
