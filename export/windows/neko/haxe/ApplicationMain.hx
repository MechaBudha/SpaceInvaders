...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Tomás Mugetti", "SpaceInvaders", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "SpaceInvaders", null, { width: 640, height: 480 });
