...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/alien.png", __ASSET__assets_images_alien_png);
		type.set ("assets/images/alien.png", AssetType.IMAGE);
		...
		className.set ("assets/images/tirobueno.png", __ASSET__assets_images_tirobueno_png);
		type.set ("assets/images/tirobueno.png", AssetType.IMAGE);
		className.set ("assets/images/tiromalo.png", __ASSET__assets_images_tiromalo_png);
		type.set ("assets/images/tiromalo.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tirobueno.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tiromalo.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_alien_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_tirobueno_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_tiromalo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/alien.png") #if display private #end class __ASSET__assets_images_alien_png extends lime.graphics.Image {}
...
@:image("assets/images/tirobueno.png") #if display private #end class __ASSET__assets_images_tirobueno_png extends lime.graphics.Image {}
@:image("assets/images/tiromalo.png") #if display private #end class __ASSET__assets_images_tiromalo_png extends lime.graphics.Image {}
